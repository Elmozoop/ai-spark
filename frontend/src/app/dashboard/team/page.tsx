  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-stone-500">The minds behind SecureAI-KYC — BITS Pilani Goa × IIT Madras 2026.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="relative mb-5">
                ...
                <div className={`absolute -bottom-1 -right-1 w-7 h-7 rounded-lg bg-white border border-stone-200 shadow-sm flex items-center justify-center`}>
              ...
              <div className="flex items-center gap-2 mt-5">
                <button className="p-1.5 rounded-lg bg-stone-50 border border-stone-200 text-stone-500 hover:text-stone-900 hover:border-stone-300 transition-colors shadow-sm">
      ...
      <motion.div
        ...
        className="p-6 rounded-2xl border border-orange-500/20 bg-orange-50 relative overflow-hidden"
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative">
          ...
          <div className="grid grid-cols-2 gap-4 md:text-right">
            <div>
              <p className="text-xs text-stone-500 uppercase tracking-wider font-bold mb-1">Domain</p>
              <p className="text-sm text-stone-700 leading-relaxed">{HACKATHON.domain}</p>
            </div>
            <div>
              <p className="text-xs text-stone-500 uppercase tracking-wider font-bold mb-1">Jury Panel</p>
